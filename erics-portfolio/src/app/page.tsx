...
function LandingPageContent() {
  ...
  const nodeData: NodeDataItem[] = [
    ...
    { id: 3, text: "Low Level Programming", description: "C/C++, RISC-V/x86 Assembly, Verilog", details:"I have taken CS61C and CS161 at Cal that have given me the ability to work on low level code."},
